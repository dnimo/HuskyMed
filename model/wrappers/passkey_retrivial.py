...
from .attention import enable_llama_flash_attention
...
def main(args):
    ...
    if args.flash_attn:
        enable_llama_flash_attention(mode="inference", use_full=True)
    ...
    for i in range(total_test_points):
        ...
        for i in range(args.num_tests):
            is_correct, len_tokens = passkey_retrieval_test(model, tokenizer, device, use_cache=not args.flash_attn,
                                                            n_garbage=n_garbage, seed=i)
